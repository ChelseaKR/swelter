...
class StoreAndForward:
    ...
    def flush(self, limit=None):
        ...
        Returns the number of payloads confirmed and dropped this call.
        """
    ...
    def _enforce_cap(self):
        ...
        if len(records) < self.max_records:
            return
        # Drop oldest to make room for the incoming append (keep max_records - 1, then add one).
        self._rewrite(records[-(self.max_records - 1):] if self.max_records > 1 else [])
