...
def build_sampler(cfg):
    ...
    Bus setup is guarded: on the node it opens the real I2C/UART; off the node the sensors are left
    unbound and read attempts surface as a missing parameter, never an invented value.
    """
    i2c = uart = None
    try:
