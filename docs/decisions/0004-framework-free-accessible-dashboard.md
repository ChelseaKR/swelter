...
and grayscale-print readers. WCAG 2.2 AA is the floor, enforced by a script in
the merge gate rather than left aspirational, so a regression fails CI, not a
later audit. We rejected a SPA framework (a build step, a bundle, a dependency
