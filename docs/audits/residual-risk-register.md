...
| R-15 | No real partner/user research means priorities and comprehension may not fit affected communities | High | Medium | Synthetic research is labeled; roadmap calls for partner research | Product owner / future partner | Open research risk; do not claim validated demand/usability |
| R-16 | GA4 page counts (ADR 0055) put a pseudonymous Google cookie on visitors outside the EEA/UK/CH and send page visits to Google | Medium | Low | Reference-host binding, GPC/DNT and remembered opt-out, ad signals denied, Google signals off, origin+path `page_location`, 14-month retention, privacy disclosure in the footer | Maintainer | Accepted by the owner 2026-09-17; review when the GA configuration, the disclosure, or the host binding changes |
