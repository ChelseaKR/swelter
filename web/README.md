...
The final MF2 unit/browser run remains pending in a clean Node 22 environment. CI is the
authoritative run; configured coverage is not presented as a local pass.
